...
Les markers (unit, integration, security, worker) sont déclarés dans pytest.ini.
"""
...
def reset_qdrant_singleton():
    ...
    # QdrantClient posé par un test fuiterait sur les suivants. On le remet à
    # None avant ET après chaque test, uniquement si le module est importé.
    def _reset():
...
def clear_dependency_overrides():
    ...
    # On ne nettoie que si l'app a réellement été importée par le test.
    yield
